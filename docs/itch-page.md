# itch.io page copy — Who Was Remembered

Reference copy for the itch.io store page. Paste and edit as needed.

## Short description (one-liner shown in listings)

> A desert of books, one for every person the English Wikipedia remembers. Walk outward to walk back in time.

## Full description

A desert under a dim sky. Books lie on the sand in every direction. Each one is a person with an English Wikipedia article, around 576,000 of them.

The centre holds the most recent lives. Walking outward carries you back through the centuries. Near the middle the books crowd together, name beside name. The further you go, the fewer remain, until single figures stand alone on open sand.
...
- Skate across open ground: hold Shift
